...
const initializeMap = async () => {
  ...
  try {
    ...
    for (const restaurant of restaurants) {
      ...
      markerElement.style.backgroundImage = 'url(/img/marker.png)'; // Set custom image URL
      markerElement.style.width = '40px';  // Adjust the width of the marker
      markerElement.style.height = '45px'; // Adjust the height of the marker
      markerElement.style.backgroundSize = '100%'; // Ensure the image covers the entire element
