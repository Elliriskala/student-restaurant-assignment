...
const initializeMap = async () => {
  ...
  try {
    ...
    for (const restaurant of restaurants) {
      ...
      const todayButton = document.createElement("button") as HTMLButtonElement;
      const weekButton = document.createElement("button") as HTMLButtonElement;
      ...
      placeholder.appendChild(todayButton);
      placeholder.appendChild(weekButton);
      placeholder.appendChild(favoriteButton);
