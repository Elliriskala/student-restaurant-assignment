...
const initializeMap = async () => {
  ...
  try {
    ...
    for (const restaurant of restaurants) {
      ...
      const buttonLI = document.createElement("li") as HTMLLIElement;
      ...
      buttonLI.appendChild(todayButton);
      buttonLI.appendChild(weekButton);
      buttonLI.appendChild(favoriteButton);
